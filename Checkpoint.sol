...
contract Checkpoint {
    ...
    uint256 payoutMileStone1 = 3 ether;
    uint256 mileStoneReward1 = 2 ether;
    uint256 payoutMileStone2 = 5 ether;
    uint256 mileStoneReward2 = 3 ether;
    uint256 payoutMileStone3 = 10 ether;
    uint256 mileStoneReward3 = 5 ether;
    ...
    function play() public payable {
        ...
        require(currentBalance <= payoutMileStone3, "Game has ended");
